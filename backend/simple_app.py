#!/usr/bin/env python3
"""
Simple Agentic Career Agent Backend for Abhinav Mishra
Eliminates [object Object] and provides dynamic responses
"""
...
def health_check():
    ...
    return jsonify({
        'status': 'healthy', 
        'service': 'Abhinav Career Agent Backend',
        'model': 'Agentic Career Agent (No Gemini)',
...
if __name__ == '__main__':
    print("🚀 Starting Agentic Career Agent Backend...")
    print("📍 Port: 5000")
    print("👤 Agent for: Abhinav Mishra")
    print("✅ Backend ready to serve!")
